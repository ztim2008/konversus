...
export function RadarList({
  radars, selectedRadarId, onSelect, onDelete,
}: {
  radars: Radar[]; selectedRadarId: string | null;
      ...
      {radars.map(radar => (
        ...
        >
          ...
          <div>
            ...
            <div className="text-xs text-gray-500">{radar.city} · {radar.leadCount} сайтов</div>
          </div>
          <button
            onClick={e => { e.stopPropagation(); onDelete(radar.id); }}
