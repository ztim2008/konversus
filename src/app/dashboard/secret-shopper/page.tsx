...
const NICHES = ["Стоматологии", "Строительство", "Кафе и рестораны", "Автосервисы", "Юристы", "Клиники", "Салоны красоты", "Фитнес-клубы", "Отели", "Грузоперевозки", "Интернет-магазины", "Недвижимость", "Бухгалтерия", "Охранные предприятия", "Рекламные агентства", "Туризм", "Образование", "Производство", "Сельское хозяйство", "IT-компании"];
    ...
    <div className="min-h-screen bg-[#0a0e13] text-gray-300 p-6 sm:p-10">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="border border-white/[0.06] bg-[#0f172a] p-6 mb-8">
          ...
          <p className="text-xs text-gray-600">Поиск по Яндекс с фильтром .ru/.рф. Множественные запросы для каждой ниши. Реальные домены.</p>
        </div>
